...
class Globals
{
	...
	public static String ApplicationName = "Uae4all2-SDL";
	public static String AppLibraries[] = { "sdl_native_helpers", "sdl-1.2", "sdl_image", "sdl_gfx", "sdl_ttf", "guichan" };
	public static String AppMainLibraries[] = {  "application", "sdl_main" };
	public static final boolean Using_SDL_1_3 = false;
	public static final boolean Using_SDL_2_0 = false;
	public static String[] DataDownloadUrl = { "!!Data files|data.zip", "!!blankdisks files|blankdisks.zip", "!!guichan files|guichan26032014.zip", "!!aros files|aros20140110.zip",  };
